...
function AccessPanel({
  ...
  return (
    <div className="flex max-h-[min(70dvh,38rem)] shrink-0 flex-col overflow-hidden rounded-xl border border-gray-200 bg-gray-50 p-4">
      ...
      {!loading && !loadError && candidates && accessByProfile && (
        <>
          {candidates.length === 0 ? (
            ...
            <div className="flex min-h-0 flex-col gap-2 overflow-y-auto overscroll-contain pe-1">
              {candidates.map(p => {
